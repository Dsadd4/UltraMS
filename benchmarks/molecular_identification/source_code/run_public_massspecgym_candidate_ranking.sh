...
python "$PUBLIC/fetch_public_inputs.py" --root "$ROOT" --dataset massspecgym
...
python "$PUBLIC/prepare_massspecgym.py" --root "$ROOT"
bash "$PUBLIC/run_massspecgym_candidate_ranking.sh"
