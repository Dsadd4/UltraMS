...
_TRAIN_DIR = os.path.dirname(_COMPARISON_DIR)
_LIGHT_ULTRA_DIR = os.path.dirname(_TRAIN_DIR)
...
sys.path.insert(0, os.environ.get('ULTRAMS_DREAMS_ROOT', os.path.join(_COMPARISON_DIR, 'resources/dreams/DreaMS')))

DREAMS_CKPT = os.environ.get('ULTRAMS_DREAMS_CKPT', os.path.join(
    _COMPARISON_DIR, 'resources/DreaMS_Check/ssl_model.ckpt'
))
N_HIGHEST_PEAKS = 60
