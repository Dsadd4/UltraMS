#!/usr/bin/env python3
"""Build an equal-polarity UltraMSdata training set from clean shards.
...
class PolarityConfig:
    source_dir: Path
    output_dir: Path
    dataset_name: str = "UltraMSdata_polarity_balanced"
    seed: int = 42
    world_size: int = 6
...
def main() -> int:
    ...
    parser.add_argument(
        "--dataset-name", default="UltraMSdata_polarity_balanced"
    )
