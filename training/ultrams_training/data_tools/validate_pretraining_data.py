...
EXPECTED_DATASET_NAMES = {
    "clean": "ae3_clean_reconstructed_v1",
    "polarity": "ae3_polarity_balanced_seed42_v1",
}
...
def audit_dataset(
    ...
    *,
    ...
    expected_name = expected_dataset_name or EXPECTED_DATASET_NAMES.get(role)
    if manifest.get("dataset_name") != expected_name:
        _error(report, f"manifest dataset_name is not the production {role} dataset")
